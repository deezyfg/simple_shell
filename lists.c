 ...
 *
 * Return: The new head node of the list, or NULL on failure.
 */
 ...
 * @num: The index of the node.
 *
 * Return: The new node added to the end of the list, or NULL on failure.
 */
...
/**
 * print_list_str - Prints the string content of each node in the linked list.
...
/**
 * free_list - Frees all memory associated with the linked list.
